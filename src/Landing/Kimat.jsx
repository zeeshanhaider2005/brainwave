...
export const Kimat = () => {
    return (
        <div className='max-w-[1230px]  mx-auto border-l border-r border-zinc-800'>
            <div className='flex flex-wrap gap-3 lg:gap-0 lg:px-3 justify-evenly py-13'>
                <div className="basic w-[380px] border p-5 rounded-3xl border-zinc-800 hover:bg-[#37352f12] ">
                    ...
                    <button className='bg-white text-[#37352F] cursor-pointer rounded-2xl w-full p-4 font-semibold hover:bg-transparent border hover:text-white duration-300 hover:scale-105'>Get Started</button>
                    <div className='mt-3'>
                ...
                <div className="basic w-[380px] border-2 p-5 rounded-3xl border-purple-800 hover:bg-[#37352f12] hover:scale-105 duration-300">
                    ...
                    <button className='bg-white text-[#37352F] cursor-pointer rounded-2xl w-full p-4 font-semibold hover:bg-transparent border border-purple-800 hover:text-white duration-300 hover:scale-105'>Get Started</button>
                    <div className='mt-3'>
                        <div className='flex items-start gap-3 border-t border-gray-800 p-4'>
                            <img src="check.svg" alt="" />
                ...
                <div className="basic w-[380px] border p-5 rounded-3xl border-zinc-800 hover:bg-[#37352f12]">
                    ...
                    <button className='bg-white text-[#37352F] cursor-pointer rounded-2xl w-full p-4 font-semibold hover:bg-transparent border hover:text-white duration-300 hover:scale-105'>Contact us</button>
                    <div className='mt-3'>
                        <div className='flex items-start gap-3 border-t border-gray-800 p-4'>
                            <img src="check.svg" alt="" />
                            <p>An AI chatbot that can understand your queries</p>
